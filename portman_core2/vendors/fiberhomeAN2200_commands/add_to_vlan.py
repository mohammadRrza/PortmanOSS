...
class AddToVlan(BaseCommand):
    ...
    def run_command(self):
        try:
            ...
            tn.write("exit\r\n\r\n")
            tn.close()
            return "{0} added to valn {1}".format(self.__port_name, self.__vlan_name)
        except Exception as e:
            print e
            return "error : {0} add to valn {1}".format(self.__port_name, self.__vlan_name)
