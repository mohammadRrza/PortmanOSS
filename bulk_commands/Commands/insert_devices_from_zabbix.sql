...
where (zabbix_hosts.device_fqdn like '%rou%' or zabbix_hosts.device_fqdn like '%core%' or zabbix_hosts.device_type = 'router_board') and router_routergroup.title is not NULL and device_fqdn not like '%OLD%' ORDER BY zabbix_hosts.device_ip;
-------------------------router-------------------------------------------------
