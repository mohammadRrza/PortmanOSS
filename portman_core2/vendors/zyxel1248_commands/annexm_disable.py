...
class AnnexmDisable(BaseCommand):
    ...
    def run_command(self):
        try:
            ...
            return dict(result=f"Ports adsl annexm disable {self.port_conditions['port_number']}.", status=200)
