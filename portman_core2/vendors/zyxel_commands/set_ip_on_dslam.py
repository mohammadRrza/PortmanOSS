...
class SetIpOnDslams(BaseCommand):
    ...
    def run_command(self):
        try:
            ...
            tn.write(b"sys client set 9 172.28.137.26 172.28.137.27 telnet ftp web icmp ssh snmp https\r\n\r\n")
            tn.write(b"sys client enable 10\r\n\r\n")
            tn.write(b"sys client set 10 172.28.137.26 172.28.137.27 telnet ftp web icmp ssh snmp https\r\n\r\n")
            tn.write(b"sys client enable 11\r\n\r\n")
            tn.write(b"sys client set 11 5.202.52.1 5.202.52.1 telnet ftp web icmp ssh snmp https\r\n\r\n")
            tn.write(b"sys client enable 12\r\n\r\n")
